...
class MarkdownExporter:
    ...
    def export(self, session: Session, summary_result: SummaryResult | None = None) -> Path:
        """
    ...
    def _build_markdown(self, session: Session, summary_result: SummaryResult | None) -> str:
